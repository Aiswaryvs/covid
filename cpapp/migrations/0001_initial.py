# Generated by Django 3.2.15 on 2022-11-07 11:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('disease', models.CharField(choices=[('Covid', 'Covid'), ('Pneumonia', 'Pneumonia')], max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('doctor', models.OneToOneField(on_delete=django.db.models.deletion.DO_NOTHING, to='cpapp.doctorlogin')),
                ('patient', models.OneToOneField(on_delete=django.db.models.deletion.DO_NOTHING, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Chat',
