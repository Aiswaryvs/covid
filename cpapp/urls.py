...
urlpatterns=[
    ...
    path('pharmacy_regiseterpage', views.pharmacy_regiseterpage, name="pharmacy_regiseterpage"),
    ...
    path('approve_pharmacy/<int:id>/', views.approve_pharmacy, name="approve_pharmacy"),
    path('remove_pharmacy/<int:id>/', views.remove_pharmacy, name="remove_pharmacy"),
    path('reject_pharmacy/<int:id>/', views.reject_pharmacy, name="reject_pharmacy"),
    ...
    path('pharmacy_profile', views.pharmacy_profile, name="pharmacy_profile"),
    path('update_pharmacy/<int:id>/', views.update_pharmacy, name="update_pharmacy"),
